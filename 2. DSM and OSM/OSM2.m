...
function OSM2(frequency,transmitting_antenna)
...
A=eval(['Smallcase21(' num2str(transmitting_antenna) ',:,frequency_index)']);
B=eval(['homo1(' num2str(transmitting_antenna) ',:,frequency_index)']);

clear Smallcase21 homo1 frequency_index;
...
eval(['save ImagingDataOSM2-' num2str(frequency) '-' num2str(transmitting_antenna) '.mat Y c d']);
